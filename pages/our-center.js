    ...
    <>
      <div className="mx-auto mb-24 mt-6 max-w-screen-xl px-4 sm:px-6 lg:px-10">
        ...
        <div className="mt-6 space-y-16 sm:space-y-20 lg:space-y-24">
          <section className="section-shell relative overflow-hidden px-6 py-10 sm:px-12">
            ...
            <div className="relative grid items-start gap-10 sm:grid-cols-[1.05fr,0.95fr]">
              <div className="text-center sm:text-left">
                ...
                <h1 className="mt-6 font-jakarta text-3xl font-extrabold leading-tight text-navy sm:text-5xl">
                  Warmth, Safety, and Joy—All Under One Roof
                </h1>
                <p className="mt-12 text-base text-slate-600 sm:text-lg">
                  Every room, routine, and relationship is intentionally designed so participants
                  feel at home and families feel confident. Expect brighter spaces, compassionate
                  experts, and engaging days that honor dignity.
                </p>
          ...
          <section>
            <SectionHeading
              eyebrow="Why Families Choose Our Center"
              title="Comfort, Clinical Oversight, and Community"
              description="Compassionate care and purposeful activities in a bright, welcoming space—every day."
            />
            ...
            <div className="relative space-y-10">
              ...
              <div className="pt-8 text-center">
                <div className="text-center">
                  <h2 className="font-jakarta text-3xl font-semibold text-navy sm:text-4xl">
                    Peek Our Center
                  </h2>
                  <p className="mx-auto mt-4 max-w-3xl text-xs font-semibold uppercase tracking-[0.2em] text-black-500">
                    Cozy space, calming colors, and flexible rooms for every part of the day.
                  </p>
                </div>
                <div className="mt-8 rounded-[32px] border border-white/40 bg-white/80 px-4 py-10 sm:px-8">
                  <GallerySection hideHeading />
                </div>
              </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-600">
                          We’ll walk through eligibility, funding, and next steps.
                        </p>
                      </div>
                    </div>
                  </div>

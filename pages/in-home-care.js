...
const InfoStat = ({ icon: Icon, label, value }) => (
  <div className="rounded-2xl border border-white/80 bg-white/80 p-4 text-left shadow-[0_10px_25px_rgba(15,34,71,0.08)] backdrop-blur">
    <div className="flex items-center gap-3">
      <span className="inline-flex h-10 items-center justify-center  text-navy">
        <Icon />
      </span>
      <div>
    ...
    <>
      ...
      <div className="mx-auto mb-24 mt-6 max-w-screen-xl px-4 sm:px-6 lg:px-10">
        ...
        <div className="mt-6 space-y-16 sm:space-y-20 lg:space-y-24">
          <section className="relative section-shell overflow-hidden px-6 py-6 sm:px-12">
            <div
            ...
            <div className="relative grid items-start gap-10 sm:grid-cols-[1.1fr,0.9fr]">
              <div className="text-center sm:text-left">
                ...
                <p className="mt-12 text-base text-slate-600 sm:text-lg">
                  Age in place with dignity. Our trained, vetted caregivers provide personal care, mobility support, light housekeeping, medication reminders, and meaningful companionship—so life at home stays safe, comfortable, and connected.
                </p>

                <div className="mt-6 block sm:hidden">
                  <div className="relative aspect-[3/3] w-full overflow-hidden rounded-3xl bg-white/30 backdrop-blur">
                    <DotLottieReact src="/assets/HomeCare.lottie" autoplay style={{ opacity: 0.85 }} />
        ...
        <section>
          <SectionHeading
            ...
            description="Tailored care services built to match the independence your loved one wants and the support they need."
          />
          <div className="mt-10 grid gap-6 lg:grid-cols-[1.1fr,0.9fr]">
            ...
            <div className="space-y-6 rounded-3xl border border-white/25 bg-[url('/assets/background-card-2.jpg')] bg-cover bg-center bg-no-repeat p-[1px]">
              <div className="rounded-[28px] bg-white/90 p-6 text-left shadow-[0_18px_35px_-28px_rgba(15,34,71,0.6)] backdrop-blur-sm">
                ...
                <h3 className="mt-2 font-jakarta text-2xl font-semibold text-navy">Designed for:</h3>
                <div className="mt-6 space-y-4">
                  {[
                    ...
                    <div key={title} className="rounded-2xl bg-white/70 p-4 shadow-[0_10px_25px_-22px_rgba(15,34,71,0.7)]">
        ...
        <section className="relative section-shell overflow-hidden px-6 py-1  sm:px-12">
          <div
            className="pointer-events-none absolute inset-0 bg-cover bg-center opacity-50"
            style={{ backgroundImage: "url('/assets/honeycomb-background.jpg')" }}
            aria-hidden="true"
          />
          <div className="relative space-y-10 my-12">
            <SectionHeading
            ...
            <div className="grid gap-8 lg:grid-cols-2">
              <div className="space-y-6">
                {[
                  ...
                  <div key={title} className="flex w-full items-start gap-4 rounded-2xl border border-white/20 bg-white/80 p-5 shadow-[0_15px_30px_-25px_rgba(15,34,71,0.65)]">
              ...
              <div className="section-shell relative overflow-hidden bg-white/90 px-6 py-6">
                <div className="relative space-y-6">
                  <div className="space-y-1 text-left">
                    ...
                    <h3 className="font-jakarta text-2xl font-semibold text-navy">What a Visit Includes</h3>
        ...
        <section>
            <SectionHeading
              ...
              description="Licensed leadership, vetted caregivers, and clear communication keep every home visit accountable."
            />
            ...
            <div className="pointer-events-none absolute inset-0 opacity-50">
              ...
              <div className="relative">
                <SectionHeading
                  ...
                  description="Choose from flexible schedules. We’ll also help you explore insurance and waiver programs."
                />
                    ...
                    <table className="w-full text-left text-sm text-slate-700">
                      ...
                      <tbody className="divide-y divide-slate-100">
                        {[
                          ...
                          ['Overnight Support', 'Evening through morning coverage for safety & rest.'],
            ...
            <div className="section-shell mt-10 divide-y divide-slate-100 bg-white/90 px-2 py-2 sm:px-4">
              {[
                ...
                <details key={item.q} className="group">
                  ...
                  {idx !== arr.length - 1 ? <div className="px-4" /> : null}
                </details>
              ))}
            </div>
          </section>
          ...
          <section>
            <div className="section-shell relative overflow-hidden px-6 py-10 sm:px-12">
              ...
              <div className="relative flex flex-col items-start justify-between gap-5 text-left md:flex-row md:items-center">
                <div>
                  <h3 className="text-xl font-semibold text-navy">Ready to meet your caregiver team?</h3>
                  <p className="mt-1 text-slate-600">Schedule a home visit or call us to start a custom plan.</p>
                </div>

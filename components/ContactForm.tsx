...
const ContactForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      {/* Message */}
      <label className="textarea border flex items-start gap-2">
        <FaCommentDots className="mt-1" />
        <textarea {...register('message')} className="grow w-full" rows={4} placeholder="Message" />
      </label>
      ...
      <button
        type="submit"
        className="w-full font-medium tracking-wide py-2 px-5 sm:px-8 border border-green-500 text-green-500 bg-white-500 outline-none  capitalize hover:bg-green-500 hover:text-white-500 transition-all hover:shadow-green "
      >
        Send Message
      </button>
    </form>

...
const defaultMeta = {
  ...
  description: 'Quality services to elevate the daily lives of adults',
  ...
  image: 'https://next-landing-vpn.vercel.app/assets/main_hero_section.jpg',
  author: 'Quality Senior Healthcare Team',
}
    ...
    <Head>
      ...
      {meta.date && (
        <>
          ...
          <meta name="publish_datee" property="og:publish_date" content={meta.date} />
